    ...
    <section className="py-24">
      <Container>
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(124, 189, 94, 0.28) 0%, rgba(158, 216, 133, 0.2) 100%), #212121",
        ...
        >
          ...
          <div className="mt-8">
            <Link
              ...
              style={{ background: "var(--gradient-primary)", boxShadow: "0 0 36px rgba(124, 189, 94, 0.35)" }}
            >
              Get Started
              <ArrowRight size={16} />
            </Link>
