...
export const metadata = {
  title: "Privacy Policy | QwickIn IT Services",
  description: "QwickIn IT Services privacy policy — how we collect, use, and protect your personal information.",
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <Container className="max-w-3xl">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs font-semibold text-[#7CBD5E] transition-colors hover:text-[#9ed885]"
        >
        ...
        <div className="mt-6">
          <span className="text-xs font-bold uppercase tracking-widest text-[#7CBD5E]">Legal</span>
        ...
        <Section title="6. Data Storage & Security">
          <p>
            ...
            access. Our founder is a practising cybersecurity professional and security is central to how we operate.
          </p>
          <p>
        ...
        <div className="mt-12 h-px bg-[#E5E5E5]" />
